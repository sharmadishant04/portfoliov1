    ...
    <footer class='flex md:justify-between border-top text-menu-text font-fira_retina'>
        ...
        <div class="w-full flex justify-between md:justify-start">
            ...
            <div id="social-icons" class="flex">
                ...
                <NuxtLink :to="social.leetcode.url + social.leetcode.user" target="_blank" class="flex md:hidden justify-center items-center">
                    <img src="/icons/social/leetcode.svg" alt="leetcode"/>
                </NuxtLink>
            </div>
        </div>
